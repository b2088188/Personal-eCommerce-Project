...
import { Container, Button, Image, Span, Title, ListGroup, Row, Col, Form, Select} from '../../design/components';
...
const ProductDetail = ({
    ...
    useEffect(() => {
        if(!id)
            return;
        getProduct(axios.get(`/api/v1/products/${id}`))        
    ...
    const onSubmit = R.curry(function (productId, {rating, review}) {
            reviewsHandle(axios.post(`/api/v1/products/${productId}/reviews`, {rating: +rating, review}));
        }, 2);
                ...
                <ListGroup bdtop>
                    ...
                    <Form onSubmit = {handleSubmit(onSubmit(id))}>
                        ...
                        <Form.Group>
                            ...
                            <Form.Input name = 'review' as = 'textarea' ref = {register({
                    ...
                    <Message alert = 'Please sign in to write down your review' severity = 'info' />}
